...
[**1\. Log in to CV-CUE CloudVision Cognitive Unified Edge	3**](#1.-log-in-to-cv-cue-cloudvision-cognitive-unified-edge)

[**2\. Creating a Guest Captive Portal	5**](#2.-creating-a-guest-captive-portal)

[**3\. WIPS Wireless Intrusion Prevention System	14**](#3.-wips-wireless-intrusion-prevention-system)

[WIPS \- Classify and Prevent individual client	18](#wips---classify-and-prevent-individual-client)

# 

# Arista WiFi Solution Diagram  {#arista-wifi-solution-diagram}

# ![](images/image2.png)

# 

# 1\. Log in to CV-CUE CloudVision Cognitive Unified Edge  {#1.-log-in-to-cv-cue-cloudvision-cognitive-unified-edge}
...
# 2\. Creating a Guest Captive Portal {#2.-creating-a-guest-captive-portal}
...
# 3\. WIPS Wireless Intrusion Prevention System {#3.-wips-wireless-intrusion-prevention-system}
...
### WIPS \- Classify and Prevent individual client {#wips---classify-and-prevent-individual-client}
